...
public class TestClass extends BaseCommandPlugin {
    ...
    public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, Map<String, MemoryAPI> memoryMap) {
        ...
        textPanel.highlightInLastPara(pc, new String[]{"\"Not really sure what we can do with that information,\"", "\"My suggestions would be... sending out some kind of signal? Scanning for something? I'm sure you'll figure it out.\""});
