...
public class OldLegionIntroQuest extends HubMissionWithSearch {
    ...
    protected boolean create(MarketAPI createdAt, boolean barEvent) {
        ...
        setStartingStage(OldLegionIntroQuest.Stage.TALK_TO_JOEL_KEPLER);
        ...
        makeImportant(OLDLEGION_NATAH, null, OldLegionIntroQuest.Stage.TALK_TO_JOEL_KEPLER);
    ...
    public void addDescriptionForNonEndStage(TooltipMakerAPI info, float width, float height) {
        ...
        if (currentStage == OldLegionIntroQuest.Stage.TALK_TO_JOEL_KEPLER) {
